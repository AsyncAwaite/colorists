...
window.addEventListener("DOMContentLoaded", function () {
  try {
    Object(_modules_adaptiveElements__WEBPACK_IMPORTED_MODULE_3__["default"])();
    window.addEventListener("scroll", headerFixed); // callback();

    var heroHeight = hero.scrollHeight;
    var menuStatus = false;

    function headerFixed() {
      if (hero !== null && window.pageYOffset >= heroHeight && menuStatus === false) {
  ...
  _createClass(Form, [{
    ...
    value: function clearInputs() {
      ...
      this.inputs.forEach(function (item) {
        ...
        _this.req.name = false;
        _this.req.oferta = false;
        _this.req.policy = false;
        _this.req.email = false; // item.nextElementSibling.textContent = "";
      });
    }
  }, {
    key: "createMask",
    value: function createMask(input) {
      ...
      var mask = new imask__WEBPACK_IMPORTED_MODULE_7__["default"](input, maskOptions);
    }
  }, {
    key: "checkInputs",
    ...
    value: function disabledBtn() {
      this.forms.forEach(function (form) {
        var chekBox = form.querySelectorAll(".form__checkbox");
        ...
        chekBox.forEach(function (item) {
          ...
          item.addEventListener("click", function () {
            if (this.classList.contains("active")) {
              console.log(this);
              this.classList.remove("active"); // this.classList.add("this");
              ...
              this.classList.add("active"); // this.classList.remove("this");
