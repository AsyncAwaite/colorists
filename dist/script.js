...
/* harmony import */ var _modules_adaptiveElements__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./modules/adaptiveElements */ "./src/js/modules/adaptiveElements.js");
/* harmony import */ var _modules_renderRewies__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./modules/renderRewies */ "./src/js/modules/renderRewies.js");
...
window.addEventListener("DOMContentLoaded", function () {
  ...
  //  new Form('.form').init();
  // renderRewies(); 
  Object(_modules_adaptiveElements__WEBPACK_IMPORTED_MODULE_3__["default"])(); // const swiper = new Swiper(".reviews", {
  //   // slidesPerView: 3,
  //   // spaceBetween: 36,
  //   centeredSlides: true,
  //   loop: true,
  ...
  _createClass(Form, [{
    ...
    value: function clearInputs() {
      ...
      this.inputs.forEach(function (item) {
        ...
        _this.req.phone = false;
        _this.req.name = false; // item.nextElementSibling.textContent = "";
      });
    }
  }, {
    key: "createMask",
    value: function createMask(input) {
      ...
      var mask = new imask__WEBPACK_IMPORTED_MODULE_8__["default"](input, maskOptions);
    }
  }, {
    key: "checkInputs",
    value: function checkInputs() {
      ...
      inputs.forEach(function (input) {
        if (input.name === "name") {
          _this2.checkNameInput(input);
        } else if (input.name === "tel") {
          _this2.checkPhoneInput(input);
        } else {
          return;
        }
      });
    ...
    value: function checkNameInput(input) {
      ...
      input.addEventListener("input", function () {
        if (input.value.length > 2) {
          ...
          input.classList.remove("invalid"); // input.nextElementSibling.textContent = "";

          _this3.req.name = true;
        } else {
          input.classList.add("invalid");
          input.classList.remove("valid"); // input.nextElementSibling.textContent = "Введите Ваше имя";
        }
      });
    }
  }, {
    ...
    value: function checkPhoneInput(input) {
      ...
      input.addEventListener("input", function () {
        if (input.value.indexOf("_") === -1) {
          ...
          _this4.req.phone = true;
        } else {
          input.classList.add("invalid");
          input.classList.remove("valid"); // input.nextElementSibling.textContent =            "Введите номер согласно шаблона";
        }
      });
    }
  }, {
    key: "disabledBtn",
    value: function disabledBtn() {
      this.forms.forEach(function (form) {
        var submitBtn = form.querySelector(".btn__form");
      });
    }
  }, {
    key: "postData",
    value: function () {
      var _postData = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(url, data) {
        var res;
    ...
    value: function init() {
      ...
      this.checkInputs(); // this.disabledBtn();

      this.forms.forEach(function (item) {
        item.addEventListener("submit", function (e) {
          e.preventDefault();
          var loadMessage = document.createElement('img');
          loadMessage.src = _this5.message.loading;
          loadMessage.style.cssText = "\n            display: block;\n            margin: 0 auto;\n        ";
          messageBox.insertAdjacentElement('afterbegin', loadMessage);

          if (_this5.req.phone && _this5.req.name) {
            var formData = new FormData(item);

            _this5.postData(_this5.path, formData).then(function (res) {
              ...
              messageBox.textContent = _this5.message.failure;
            }).finally(function () {
              _this5.clearInputs();
...
var menu = _elements__WEBPACK_IMPORTED_MODULE_0__["header"].querySelector(".menu");
var headerBtn = document.querySelector(".btn");
var forWhoSection = _elements__WEBPACK_IMPORTED_MODULE_0__["page"].querySelector('.for-who');

var adaptiveElements = function adaptiveElements() {
  if (matchMedia("(max-width: 992px)").matches) {
    var forWhoSectionBtn = forWhoSection.querySelector('.btn');
    forWhoSectionBtn.innerHTML += "\n<div class=\"course-name pos-a\">\n<svg class=\"icon\">\n  <use xlink:href=\"#course-name\"></use>\n</svg>\n</div>";
  }

  if (matchMedia("(max-width: 768px)").matches) {
    var mobileMenu = menu;
    var footerBtn = headerBtn;
    footerBtn.classList.add("btn-buy");
    headerBtn.parentElement.remove();
    headerBtn.remove();
    menu.remove();
    _elements__WEBPACK_IMPORTED_MODULE_0__["footer"].insertAdjacentElement("afterend", footerBtn);
    ...
    _elements__WEBPACK_IMPORTED_MODULE_0__["header"].prepend(burger);
    _elements__WEBPACK_IMPORTED_MODULE_0__["header"].appendChild(instaLink);
    var mobileMenuWrapper = document.createElement("div");
    _elements__WEBPACK_IMPORTED_MODULE_0__["header"].appendChild(mobileMenuWrapper);
    ...
    var promoImgWrapper = document.querySelector(".promo-img-wrapper");
    var promoText = document.querySelector(".promo-text");
    var promoBtn = promoText.querySelector(".btn");
    var promoBtnCopy = promoBtn;
    promoBtn.remove();
...
/*!************************************!*\
  !*** ./src/js/modules/elements.js ***!
  \************************************/
/*! exports provided: page, header, footer */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
var header = page.querySelector(".header__nav"); // const headerBtn = document.querySelector(".btn");

var footer = document.querySelector(".footer"); // const menu = header.querySelector(".menu");
...
/***/ "./src/js/modules/renderRewies.js":
/*!****************************************!*\
  !*** ./src/js/modules/renderRewies.js ***!
  \****************************************/
/*! exports provided: default */
...
/* harmony import */ var _elements__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./elements */ "./src/js/modules/elements.js");
...
swiper__WEBPACK_IMPORTED_MODULE_4__["default"].use([swiper__WEBPACK_IMPORTED_MODULE_4__["Navigation"], swiper__WEBPACK_IMPORTED_MODULE_4__["Pagination"], swiper__WEBPACK_IMPORTED_MODULE_4__["Thumbs"]]);

var reviewsWrapper = _elements__WEBPACK_IMPORTED_MODULE_5__["page"].querySelector(".swiper-wrapper");

var renderRewies = function renderRewies() {
  getRewies();
};

var swiperRewies = function swiperRewies() {
  var swiper = new swiper__WEBPACK_IMPORTED_MODULE_4__["default"](".reviews", {
    slidesPerView: 3,
    spaceBetween: 36,
    loop: true,
    centeredSlides: true,
...
var getRewies = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee() {
    var response, reviews, fragment;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            _context.next = 3;
            return fetch("./assets/services/rewies.json");
  ...
  return function getRewies() {
    return _ref.apply(this, arguments);
  };
}();

/* harmony default export */ __webpack_exports__["default"] = (renderRewies);
